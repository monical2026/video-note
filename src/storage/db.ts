...
export const saveTranscript = (videoId: string, cues: Cue[], terms?: Term[], polishedAt?: number, raw?: Cue[]) =>
  db().then((d) => d.put('transcripts', { cues, terms: terms ?? [], polishedAt, raw } satisfies TranscriptRecord, videoId));
